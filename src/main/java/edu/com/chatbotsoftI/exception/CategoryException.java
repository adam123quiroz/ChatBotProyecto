...
import edu.com.chatbotsoftI.auxiliar.SequenceUpdateEvent;
...
public class CategoryException extends RuntimeException {
    private static final Logger LOGGER = LoggerFactory.getLogger(CategoryException.class);


    public CategoryException(BoltonBot bot, Sequence sequenceUpdateEvent, Message message, int step) throws TelegramApiException {
